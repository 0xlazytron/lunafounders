import{i as N,a as k,x as a,r as L,e as v,D as p,d as O,R as Y,O as V,f as z,A as E,W}from"./index-C5AVI2mg.js";import{n as l,c as _,o as j,r as b}from"./index-CeZamq-X.js";import{T as A,D as F}from"./index-C3aFM-aU.js";import"./index-BonVIxkM.js";import"./index-Bga4A2C4.js";import"./index-DF05vYWs.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
