import{q as h,u as m,v as w,i as f,a as v}from"./index-8HPz122D.js";import{x as b}from"./lit-html-Bx_euVSL.js";import{r as u,c as g}from"./index-BKgjBXqP.js";const e=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return w(e,()=>o(e))},subscribeKey(o,t){return m(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=f`
  :host {
    pointer-events: none;
  }
