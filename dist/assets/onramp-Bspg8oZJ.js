import{q as ie,w as Z,B as K,x as q,e as A,c as se,A as $,y as oe,u as ne,v as ae,i as R,a as y,z as j,D as C,O as U,M as _,p as ce,f as ee,W as te,R as E,d as F,b as V,k as le,S as M,T as ue}from"./index-BwoMNPU_.js";import{x as c}from"./lit-html-Bx_euVSL.js";import{n as p,c as g,o as h,r as d}from"./index-DHrlETog.js";import{D as de,T as pe}from"./index-CejKDg9m.js";import"./index-CNpvtWQK.js";import"./index-DhqnVWsn.js";import"./index-PgJg5n5l.js";import"./index-BRN71zyX.js";import{O as Y}from"./index-B0Me7orr.js";import"./index-btGkulaY.js";import"./index-BCawK7Rl.js";import"./index-DQzbgvba.js";import"./index-KSLeK6lx.js";import"./index-D_RDdoYI.js";const L={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},H={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},me={providers:Z,selectedProvider:null,error:null,purchaseCurrency:L,paymentCurrency:H,purchaseCurrencies:[L],paymentCurrencies:[],quotesLoading:!1},l=ie(me),u={state:l,subscribe(s){return ae(l,()=>s(l))},subscribeKey(s,e){return ne(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=A.state.activeChain===se.CHAIN.SOLANA?"SOL":"USDC",t=$.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",oe),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||H,l.purchaseCurrency=s.purchaseCurrencies[0]||L,await q.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await q.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=Z,l.selectedProvider=null,l.error=null,l.purchaseCurrency=L,l.paymentCurrency=H,l.purchaseCurrencies=[L],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
